        ...
        <aside class="w-[300px] bg-[#1F2129] min-h-screen">
                        ...
                        <template #trigger>
                            <button class="w-full flex items-center gap-3 p-2 hover:bg-[#36393f] rounded text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="text-sm font-semibold truncate">{{ guild?.name || 'Server auswählen' }}</div>
                                </div>
                        ...
                        <template #content>
                            <div class="max-h-96 overflow-y-auto py-1 bg-[#1e1f22]">
                                ...
                                >
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="text-xs font-medium text-white">Neuen Server hinzufügen</div>
                                    </div>
                                </Link>
                            </div>
                        </template>
                ...
                <nav class="space-y-1">
                    ...
                    <div>
                        ...
                        >
                            <span class="text-xs font-semibold uppercase">Grundlegende Informationen</span>
                            <svg
                        ...
                        <div v-show="basicInfoOpen" class="ml-4 space-y-1 mt-1">
                            ...
                            >
                                ...
                                <span class="text-sm">Begrüßung</span>
                            </Link>
                            <Link
                            ...
                            >
                                ...
                                <span class="text-sm">Reaktionsrollen</span>
                            </Link>
                            <Link
                            ...
                            >
                                ...
                                <span class="text-sm">Auto-Moderation</span>
                            </Link>
                            <Link
                            ...
                            >
                                ...
                                <span class="text-sm">Aufleveln</span>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div>
                        <button
                            ...
                            class="w-full flex items-center justify-between px-3 py-2 rounded mb-1 transition-colors text-gray-300 hover:text-white"
                        >
                            <span class="text-xs font-semibold uppercase">Social Media Benachrichtigungen</span>
                            <svg
                                class="w-4 h-4 transition-transform duration-200"
                    ...
                    <div>
                        <button
                            ...
                            class="w-full flex items-center justify-between px-3 py-2 rounded mb-1 transition-colors text-gray-300 hover:text-white"
                        >
                            <span class="text-xs font-semibold uppercase">Server-Verwaltung</span>
                            <svg
                                class="w-4 h-4 transition-transform duration-200"
                        ...
                        <div v-show="serverManagementOpen" class="ml-4 space-y-1 mt-1">
                            ...
                            >
                                ...
                                <span class="text-sm">Ticket-System</span>
                            </Link>
                        </div>
                    </div>
                </nav>
