                ...
                <nav class="space-y-1">
                    ...
                    <div>
                        ...
                        <div v-show="serverManagementOpen" class="ml-4 space-y-1 mt-1">
                            ...
                            <Link
                                :href="route('guild.statistics-channel', { guild: guild?.id })"
                                :class="[
                                    'flex items-center gap-3 px-3 py-2 rounded transition-colors',
                                    route().current('guild.statistics-channel') ? 'bg-[#36393f] text-white' : 'text-gray-400 hover:bg-[#36393f] hover:text-white'
                                ]"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                                <span class="text-sm">{{ t('navigation.statisticsChannel') }}</span>
                            </Link>
                            <Link
                    ...
                    <div>
                        ...
                        <div v-show="gamesAndFunOpen" class="ml-4 space-y-1 mt-1">
                            ...
                            <Link
                                :href="route('guild.birthdays', { guild: guild?.id })"
                                :class="[
                                    'flex items-center gap-3 px-3 py-2 rounded transition-colors',
                                    route().current('guild.birthdays') ? 'bg-[#36393f] text-white' : 'text-gray-400 hover:bg-[#36393f] hover:text-white'
                                ]"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <span class="text-sm">{{ t('navigation.birthdays') }}</span>
                            </Link>
                        </div>
                    </div>
