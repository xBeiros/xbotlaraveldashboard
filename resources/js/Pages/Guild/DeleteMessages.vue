            ...
            <div class="bg-[#2f3136] rounded-lg p-6 border border-[#202225] mt-6">
                ...
                <div class="mb-6 p-4 bg-red-500/20 border border-red-500/50 rounded-lg">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-red-400 mb-2">{{ $t('deleteMessages.autoDelete.warningTitle') }}</p>
                            <p class="text-sm text-red-300 leading-relaxed">{{ $t('deleteMessages.autoDelete.warningDescription') }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    >
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                >
                                    {{ autoDelete.enabled ? $t('deleteMessages.autoDelete.deactivate') : $t('deleteMessages.autoDelete.activate') }}
                                </button>
                                <button
