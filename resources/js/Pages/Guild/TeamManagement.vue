                ...
                <div v-else class="space-y-3">
                    ...
                    >
                        <div class="flex items-center gap-4 flex-1">
                            ...
                            <div class="flex-1">
                                <h3 class="text-white font-semibold">{{ rank.name }}</h3>
            ...
            <div class="bg-[#2f3136] rounded-lg border border-[#202225] p-6 mb-6">
                ...
                <div v-else class="space-y-2">
                    <div
                        ...
                        :key="member.id"
                        class="flex items-center justify-between p-3 bg-[#36393f] rounded-lg border border-[#202225]"
                    >
                        <div class="flex items-center gap-3">
                            <div class="text-white">
                                {{ getMemberName(member.user_id) }}
                            </div>
                            <span class="text-sm text-gray-400">{{ member.rank_name }}</span>
                        </div>
                        <button
...
const getMemberName = (userId) => {
    ...
    return member ? member.display_name : userId;
};
